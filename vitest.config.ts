...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      'src/lib/appConnectivityInset.test.ts',
      ...
      'src/lib/freeSpacePdfOpen.test.ts',
      'src/lib/freeSpacePdfIdb.saveStatus.test.ts',
      'src/lib/spatialAssetCloud.pdfHydrate.test.ts',
      'src/lib/spatialAssetCloud.pdfHydrate.saveStatus.test.ts',
      'src/lib/pdfStudyMarks/pdfStudyMarksIdb.test.ts',
      'src/lib/pdfStudyMarks/PdfStudyMarksOverlay.ink.test.tsx',
      ...
      'src/lib/handwritingCanvasBacking.test.ts',
      'src/lib/notebookMobileChrome.test.ts',
      'src/lib/workspacePresentationProfile.test.ts',
      'src/lib/sectionViewModePhoneDefault.test.ts',
      'src/lib/phoneLazyFreeSpace.test.ts',

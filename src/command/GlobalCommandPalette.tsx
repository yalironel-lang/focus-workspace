...
export function GlobalCommandPalette() {
  ...
  const commands = useMemo((): CommandItem[] => {
    ...
    list.push({
      ...
      label: 'Local intelligence & legacy cloud…',
      subtitle: 'Not Ask ZIKUK — optional BYOK model settings',
      keywords: [
        'intelligence',
        'local',
        'mistakes',
          ...
          ? ([
              {
                ...
                groupLabel: 'Legacy cloud model (not Ask ZIKUK)',
                label: 'Summarize note (cloud)',
                subtitle: 'BYOK provider — not Ask ZIKUK',

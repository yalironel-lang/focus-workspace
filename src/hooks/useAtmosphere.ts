...
export const ATMOSPHERES: AtmosphereTokens[] = [
  ...
  // ─── Neural ── warm amber signals on deep warm navy ─────────────────────────
  {
    ...
    pageBg:           '#14100c',
    navBg:            'rgba(20,16,12,0.92)',
    cardBg:           '#201b14',
    cardBorder:       'rgba(255,200,120,0.17)',
    cardBorderHover:  'rgba(255,200,120,0.30)',
    wellBg:           '#16120d',
    textPrimary:      '#f5ede0',
    ...
    focusBorder:      '#f59e0b',
    ambientGlow1:     'rgba(245,158,11,0.06)',
    ambientGlow2:     'rgba(180,100,20,0.04)',
    shadowSm:         '0 1px 3px rgba(0,0,0,0.40)',
    shadowMd:         '0 8px 24px rgba(0,0,0,0.42), inset 0 1px 0 rgba(255,200,120,0.08)',
    shadowLg:         '0 16px 44px rgba(0,0,0,0.48), inset 0 1px 0 rgba(255,200,120,0.10)',
    blur:             20,
    glowIntensity:    0.58,
    radius:           16,
    density:          'comfortable',
